...
import {catalogBatchProcess, createProduct, getProductsById, getProductsList} from "@functions/index";
  ...
  resources: {
    Resources: {
      ...
      createProductSubscription: {
        ...
        Properties: {
          Protocol: 'email',
          Endpoint: 'aleh_navoyeu@epam.com',
          TopicArn: {
